 ...
 */
public class TestClusterParams_alt {
    public static void main(String[] args){
        String trialName = "" + new Date().getTime();
    ...
    private static void runOneConfiguration(int cacheSize,int numWords,
        ...
        String pathTraining = "corpus_jpg30vh/";
        String pathTest = "query_jpg30vh/";
        ...
        try {
            ...
            String configName = "" + cacheSize+numWords+useCanopies+
